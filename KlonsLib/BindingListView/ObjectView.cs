...
namespace Equin.ApplicationFramework
{
    ...
    public class ObjectView<T> : INotifyingEditableObject, IDataErrorInfo, INotifyPropertyChanged, ICustomTypeDescriptor, IProvideViews
    {
        ...
        public ObjectView(T @object, AggregateBindingListView<T> parent)
        {
            ...
            Object = @object;
            if (_parent.HookItemEvents && Object is INotifyPropertyChanged)
            {
        ...
        public T Object
        {
            ...
            private set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("Object", Messages.ObjectCannotBeNull);
                }
                _object = value;
            }
        }
        ...
        protected virtual void OnEditEnded(bool haschanged)
        {
            if (EditEnded != null)
            {
                EditEnded(this, new ObjectViewEndEditEventArgs(haschanged));
            }
        }
        ...
        public void EndEdit()
        {
            ...
            if (_editing)
            {
                ...
                if (_backup != null)
                {
                    haschanges = _backup.HasChanges(this);
                    _backup = null;
                }
                OnEditEnded(haschanges);
                // No longer editing now.
                _editing = false;
            }
        }
