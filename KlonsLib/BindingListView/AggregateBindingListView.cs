...
{
    public class AggregateBindingListView<T> : Component, IBindingListView, IList, IRaiseItemChangedEvents, 
        ICancelAddNew, ITypedList, IEnumerable<T>, IMyBindingListView
    {
        #region Constructors
        ...
        public bool HookItemEvents = false;
        ...
        public IList SourceLists
        {
            ...
            set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("SourceLists", Messages.SourceListsNull);
                }
                ...
                foreach (object obj in value)
                {
                    ...
                    foreach (object item in list)
                    {
                        if (!(item is T))
                        {
                            throw new InvalidSourceListException(string.Format(Messages.InvalidListItemType, typeof(T).FullName));
                        }
                    }
                }
        ...
        {
            var empty_source_list = new List<List<T>>();
        ...
        protected virtual T OnAddingNew()
        {
            ...
            {
                throw new InvalidOperationException(Messages.CannotAddNewItem);
            }
        }
        ...
        public IList NewItemsList
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(Messages.SourceListNotFound);
                }
                _newItemsList = value;
            }
        }
        ...
        //ObjectBackupTable objectBackupTable = new BL2024.ObjectBackupTable();

        /// <remarks>
        /// Currently unused. Here in case we want to perform actions when
        /// an item edit begins.
        /// </remarks>
        protected virtual void BeginItemEdit(object sender, EventArgs e)
        {
            //objectBackupTable.Backup(sender);
        }
        ...
        {
            //objectBackupTable.Restore(sender);
        }
        ...
        {
            //objectBackupTable.Remove(sender);

            if (e is ObjectViewEndEditEventArgs eva && !eva.HasChanges)
                return;
        ...
        public void ApplyFilter(Predicate<T> includeItem)
        {
            if (includeItem == null)
            {
                throw new ArgumentNullException("includeItem", Messages.IncludeDelegateCannotBeNull);
            }
        ...
        */
        ...
        private class SortComparer : IComparer<KeyValuePair<ListItemPair<T>, int>>
        {
            ...
            public int Compare2(KeyValuePair<ListItemPair<T>, int> x, KeyValuePair<ListItemPair<T>, int> y)
            {
            ...
            public int Compare(KeyValuePair<ListItemPair<T>, int> x, KeyValuePair<ListItemPair<T>, int> y)
            {
                foreach (ListSortDescription sort in _sorts)
                {
                    ...
                    {
                        // null < object
                        return sort.SortDirection == ListSortDirection.Ascending ? -1 : 1;
                    }
                    if (valueX != null && valueY == null)
                    {
                        // object > null
        ...
        public int Find(string propertyName, object key)
        {
            ...
            {
                throw new ArgumentException(string.Format(Messages.PropertyNotFound, propertyName, typeof(T).FullName), "propertyName");
            }
        }
        ...
        int IList.Add(object value)
        {
            ...
            throw new NotSupportedException(Messages.CannotAddItem);
        }
        ...
        void IList.Clear()
        {
            throw new NotSupportedException(Messages.CannotClearView);
        }
        ...
        {
            throw new NotSupportedException(Messages.CannotInsertItem);
        }
        ...
        object IList.this[int index]
        {
            ...
            set
            {
                ...
                // in this manner.
                throw new NotSupportedException(Messages.CannotSetItem);
            }
        }
        ...
        {
            get { throw new NotSupportedException(Messages.SyncAccessNotSupported); }
        }
        ...
        {
            editableObject.EditBegun += new EventHandler(BeginItemEdit);
